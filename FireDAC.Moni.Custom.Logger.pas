{$HPPEMIT LINKUNIT}
unit FireDAC.Moni.Custom.Logger;
...
type
  ...
  public
    function CurSender: TObject; safecall;
    destructor Destroy; override;
  end;
...
function TFDMoniCustomClient.CurSender: TObject;
begin
  Result := FCurSender;
end;
